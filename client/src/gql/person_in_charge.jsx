...
export const PERSON_IN_CHARGES_BY_COMMITTEE_AND_PROJECT_QUERY = gql`
  query person_in_charges_by_committee_and_project($committee_id: String!,$project_id: String!){
    person_in_charges_by_committee_and_project(committee_id:$committee_id, project_id:$project_id) {
      _id
      order
      staff_id
      position_id
