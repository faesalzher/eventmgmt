...
export default function SponsorEditForm(props) {
  ...
  const intitialFormState = {
    _id: uuid(),
    sponsor_name: props.sponsor.sponsor_name,
    event_id: props.sponsor.event_id,
    contact_person: props.sponsor.contact_person,
    details: props.sponsor.details,
    imageUrl: props.sponsor.imageUrl,
  }
  const [sponsorForm, setSponsorForm] = useState(intitialFormState);

  const handleSaveEditButton = () => {
    props.handleSaveEditButton(sponsorForm, props.index)
